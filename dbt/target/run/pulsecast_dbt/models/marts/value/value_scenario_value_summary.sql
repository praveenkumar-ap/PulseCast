  ...
  create  table "pulsecast"."value"."scenario_value_summary__dbt_tmp"
...
with header as (
    select
        ...
        uplift_percent,
        created_at
    from "pulsecast"."scenarios"."header"
),
results as (
    select
        scenario_id,
        sum(p50) as total_p50
    from "pulsecast"."scenarios"."results"
...
inventory as (
    select
        ...
        count(*) as rec_count
    from "pulsecast"."inventory"."recommendations"
