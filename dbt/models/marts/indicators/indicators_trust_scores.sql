{{ config(alias="trust_scores", schema="indicators", materialized="view") }}

with catalog as (
    select * from {{ ref('indicators_catalog') }}
),
latest_quality as (
