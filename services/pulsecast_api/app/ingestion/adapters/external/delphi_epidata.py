...
@register_adapter
class DelphiEpidataAdapter(BaseBatchAdapter):
    """Ingest epidemiological signals from Delphi Epidata FluView endpoint."""
    ...
    def ingest(
        ...
        *,
        ...
        if not regions or not start_week or not end_week:
            logger.warning("FluView config incomplete; skipping ingestion.")
